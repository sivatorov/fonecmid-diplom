...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПолныеПраваНаВарианты Тогда
		...
		Элементы.ПоказыватьЛичныеВариантыОтчетовДругихАвторовСЕК.Видимость = Ложь;
...
Процедура ПередЗагрузкойДанныхИзНастроекНаСервере(Настройки)
	...
	Если Показывать <> ПоказыватьЛичныеВариантыОтчетовДругихАвторов Тогда
		...
		Элементы.ПоказыватьЛичныеВариантыОтчетовДругихАвторовСЕК.Пометка = Показывать;
		ЗаполнитьСписокВариантов();
	КонецЕсли;
КонецПроцедуры
...
Процедура ПоказыватьЛичныеВариантыОтчетовДругихАвторов(Команда)
	...
	Элементы.ПоказыватьЛичныеВариантыОтчетовДругихАвторовСЕК.Пометка = ПоказыватьЛичныеВариантыОтчетовДругихАвторов;
