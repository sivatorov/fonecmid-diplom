...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// {{ СЕК 02.04.24
	ОписаниеПрофиля.Роли.Добавить("СЕК_ОбслуживаниеКлиента");
	// СЕК 02.04.24 }}
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	...
	// {{ СЕК 02.04.24
	ОписаниеПрофиля.Роли.Добавить("СЕК_МассовоеСозданиеДокументов");
	// СЕК 02.04.24 }}
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	// {{ СЕК 02.04.2024 Добавление профиля "Специалист по обслуживанию клиентов"
	...
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Специалист по обслуживанию клиентов'",
		ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	...
	// СЕК Конец добавления }}
	
	//{{ СЕК 02.04.2024 Добавление профиля "Кадровик-расчетчик"
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("СЕК_ЗарплатыГрафики");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
